...
func (rm *resourceManager) EnsureReferences(
	...
	if desiredKO.Spec.CapacityReservationSpecification != nil {
		if desiredKO.Spec.CapacityReservationSpecification.CapacityReservationTarget != nil {
			if len(desiredKO.Spec.CapacityReservationSpecification.CapacityReservationTarget.CapacityReservationRefs) > 0 {
				if latestKO.Spec.CapacityReservationSpecification == nil {
					latestKO.Spec.CapacityReservationSpecification = &svcapitypes.CapacityReservationSpecification{}
				}
				if latestKO.Spec.CapacityReservationSpecification.CapacityReservationTarget == nil {
					latestKO.Spec.CapacityReservationSpecification.CapacityReservationTarget = &svcapitypes.CapacityReservationTarget{}
				}
				if len(latestKO.Spec.CapacityReservationSpecification.CapacityReservationTarget.CapacityReservationRefs) == 0 {
					latestKO.Spec.CapacityReservationSpecification.CapacityReservationTarget.CapacityReservationRefs = desiredKO.Spec.CapacityReservationSpecification.CapacityReservationTarget.CapacityReservationRefs
				}
			}
		}
	}
