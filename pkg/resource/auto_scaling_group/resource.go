...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.AutoScalingGroupName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["autoScalingGroupName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: autoScalingGroupName"))
	}
	r.ko.Spec.AutoScalingGroupName = &primaryKey
